...
class StockDataService:
    ...
    async def get_quote(self, symbol: str) -> Dict[str, Any]:
        ...
        log_api_call(endpoint="get_quote", method="GET", context={"symbol": symbol})
        ...
        try:
            ...
            if cached_data:
                ...
                log_info(
                    ...
                    context={
                        "symbol": symbol,
                        "cache_age_seconds": cached_data.get("cache_age"),
                    },
                    logger_name="api",
                )
                return cached_data
    ...
    def _validate_and_normalize_quote(
        ...
        try:
            ...
            if not validation_result.is_valid:
                raise DataValidationError(
                    f"검증 실패: {', '.join(validation_result.errors)}"
                )
    ...
    async def _check_rate_limit(self) -> None:
        ...
        if len(self.request_times) >= self.max_requests_per_minute:
            ...
            raise RateLimitExceededError(
                f"Rate limit 초과, {wait_time:.1f}초 대기 필요"
            )
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        if stats_info["total_requests"] > 0:
            ...
            stats_info["cache_hit_rate"] = (
                stats_info["cache_hits"]
                / (stats_info["cache_hits"] + stats_info["cache_misses"])
                * 100
            )
        else:
        ...
        log_info("통계 조회", context=combined_stats, logger_name="api")
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_info("헬스체크 성공", context=health_status, logger_name="api")
