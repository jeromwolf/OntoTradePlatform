...
async def get_user_profile():
    ...
    try:
        ...
        capture_exception(
            e, {"endpoint": "GET /users/profile", "operation": "get_user_profile"}
        )
        ...
        with logging_system.performance_monitor.measure_operation(
            ...
            log_info(
                ...
                context={
                    "fields_to_update": list(
                        profile_data.dict(exclude_unset=True).keys()
                    ),
            ...
            if not update_fields:
                log_warning(
                    ...
                    context={"error": "no_fields_to_update"},
                )
...
async def get_user_stats():
    ...
    try:
        ...
        capture_exception(
            e, {"endpoint": "GET /users/stats", "operation": "get_user_stats"}
        )
    ...
    try:
        with logging_system.performance_monitor.measure_operation(
            ...
            log_info(
                "리더보드 조회 시작",
                category="user",
                context={"limit": limit, "source": "user_endpoint"},
            )
            ...
            if limit is not None and (limit < 1 or limit > 100):
                log_warning(
                    ...
                    category=ErrorCategory.VALIDATION.value,
                    severity=ErrorSeverity.MEDIUM.value,
                    context={"limit": limit, "error": "invalid_limit_range"},
                )
            ...
            if limit is not None:
                leaderboard_data["leaderboard"] = leaderboard_data["leaderboard"][
                    :limit
                ]
        ...
        log_error(
            ...
            category=ErrorCategory.BUSINESS_LOGIC.value,
            severity=ErrorSeverity.HIGH.value,
            context={"limit": limit, "error": str(e), "error_type": type(e).__name__},
        )
...
async def delete_user_account():
    ...
    try:
        ...
        capture_exception(
            e, {"endpoint": "DELETE /users/account", "operation": "delete_user_account"}
        )
