...
async def add_to_watchlist(
    ...
    try:
        # 이미 관심종목에 있는지 확인
        is_already_added = await supabase_service.is_in_watchlist(user_id, request.symbol)
...
async def remove_from_watchlist(
    ...
    try:
        # 관심종목에 있는지 확인
        is_in_watchlist = await supabase_service.is_in_watchlist(user_id, request.symbol)
