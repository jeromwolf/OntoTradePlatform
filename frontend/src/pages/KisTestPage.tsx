...
import { Button, Card, Input, Select, Table, Tabs, Typography, message } from 'antd';
...
const KisTestPage: React.FC = () => {
  ...
  const dummyStocks: StockInfo[] = [
    { code: '005930', name: '삼성전자', price: 72500, change: 1500, changePercent: 2.11, volume: 12450234 },
    { code: '035720', name: '카카오', price: 51200, change: -1200, changePercent: -2.29, volume: 5234123 },
    { code: '207940', name: '삼성바이오로직스', price: 856000, change: 12500, changePercent: 1.48, volume: 123456 },
  ];
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Card style={{ marginBottom: '24px' }}>
        ...
        <Tabs activeKey={activeTab} onChange={setActiveTab}>
          ...
          <TabPane 
            tab={
              <>
                {selectedStock ? `${selectedStock.name} (${selectedStock.code})` : t('종목 상세')}
              </>
            } 
            key="detail"
          ...
          >
            {selectedStock ? (
              <div style={{ padding: '16px' }}>
                <Title level={4}>{selectedStock.name} ({selectedStock.code})</Title>
      ...
      <Card title="API 호출 로그" style={{ marginTop: '16px' }}>
        <div style={{ minHeight: '100px', fontFamily: 'monospace', padding: '8px' }}>
