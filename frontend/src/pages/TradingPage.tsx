...
const TradingPage: React.FC = () => {
  ...
  // 내 포지션 (더미 데이터)
  const myPositions = [
    { symbol: "AAPL", quantity: 50, value: 7512.5 },
    { symbol: "TSLA", quantity: 25, value: 6145.0 },
    { symbol: "MSFT", quantity: 20, value: 6403.0 },
  ];

  // 호가창 데이터 (더미)
  const orderBook: OrderBookData = {
    sellOrders: [
      { price: 150.3, quantity: 100 },
          ...
          <div className="w-64 bg-gray-800 border-r border-gray-700 p-4 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  language === "ko" ? "종목명 입력..." : "Enter symbol..."
                }
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`text-lg font-semibold ${currentData.change >= 0 ? "text-green-400" : "text-red-400"}`}
                        >
              ...
              <div className="space-y-2">
                {sectors.map((sector) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-sm font-semibold ${sector.change >= 0 ? "text-green-400" : "text-red-400"}`}
                    >
                      {sector.change >= 0 ? "+" : ""}
            ...
            <div className="bg-gray-800 rounded-lg p-6 mb-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <span
                    className={`text-lg font-semibold ${selectedStock.change >= 0 ? "text-green-400" : "text-red-400"}`}
                  >
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1 bg-gray-600 rounded text-sm">
                    5분
                  </button>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  {orderBook.sellOrders.map((order, index) => (
                    <div
                      key={index}
                      className="flex justify-between items-center p-2 bg-red-900/20 rounded"
                    >
