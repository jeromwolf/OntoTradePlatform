              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "8px 12px",
                    background:
                      activeCategory === item.key ? "#3b82f6" : "transparent",
            ...
            >
              ...
              >
                ...
                <p style={{ margin: 0, fontSize: "12px", color: "#94a3b8" }}>
                  {t(
                    "노드를 클릭하여 연결된 정보를 탐색하세요",
                    "Click nodes to explore connected information",
                  )}
                </p>
              </div>
            </div>
            ...
            >
              {[
                ...
                },
                {
                  title: t(
                    "아이폰 15 중국 판매량 하락",
                    "iPhone 15 Sales Drop in China Market",
                  ),
                  source: "Bloomberg",
                ...
                },
                {
                  title: t(
                    "AI 칩 개발 가속화 발표",
                    "AI Chip Development Accelerated",
                  ),
                  source: "TechCrunch",
                ...
                },
                {
                  title: t(
                    "신형 맥북 프로 출시 예정",
                    "New MacBook Pro Launch Expected",
                  ),
                  source: "9to5Mac",
