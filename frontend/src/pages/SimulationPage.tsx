...
const SimulationPage: React.FC = () => {
  ...
  const handleTrade = useCallback(async () => {
    if (!selectedStock || tradeQuantity <= 0) {
      setError(
        t("주식과 수량을 선택하세요.", "Please select stock and quantity."),
      );
      return;
    }
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "거래 실행에 실패했습니다.",
      );
    } finally {
      setIsTrading(false);
    }
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        {formatPercent(session.total_pnl_percent)})
                      </div>
                    </div>
                ...
                >
                    ...
                    {selectedStock && stockData[selectedStock] && (
                      ...
                      >
                        ...
                        >
                          <div>
                            <div
                              style={{ fontWeight: "bold", color: "#e2e8f0" }}
                            >
                          ...
                          <div style={{ textAlign: "right" }}>
                            ...
                            >
                              ...
                              {stockData[selectedStock].change >= 0 ? "+" : ""}
                              {stockData[selectedStock].change_percent.toFixed(
                                2,
                              )}
                              %)
                            </div>
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          background:
                            tradeAction === "SELL" ? "#dc2626" : "#334155",
                          color: "white",
                          fontWeight: "bold",
                        }}
                      >
                  ...
                  {selectedStock && stockData[selectedStock] && (
                    ...
                    >
                      ...
                      <div style={{ fontWeight: "bold", fontSize: "16px" }}>
                        {formatCurrency(
                          stockData[selectedStock].price * tradeQuantity,
                        )}
                      </div>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor:
                        !selectedStock || tradeQuantity <= 0 || isTrading
                          ? "not-allowed"
                          : "pointer",
                      background:
                        !selectedStock || tradeQuantity <= 0 || isTrading
                ...
                >
                  {leaderboard.slice(0, 10).map((entry) => (
                    <div
                      ...
                      style={{
                        background:
                          entry.user_id === user?.id ? "#1e293b" : "#0f172a",
                        padding: "16px",
                        borderRadius: "8px",
                        border:
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: "12px", color: "#94a3b8" }}>
                              {t("종목", "Holdings")}: {entry.holdings_count} |{" "}
                              {t("거래", "Trades")}: {entry.transactions_count}
                            </div>
                          </div>
                        </div>
                        <div style={{ textAlign: "right" }}>
                          ...
                          <div
                            style={{
                              fontSize: "14px",
                              color:
                                entry.total_pnl >= 0 ? "#34d399" : "#ef4444",
                            }}
                          >
